#pragma checksum "D:\code\Lessons\Ogani project from Mac\OganiMvcProject\Ogani\Ogani.WebUI\Areas\Admin\Views\Account\AccessDenied.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0d412c2cff36b5b7301ffe459e1250b2491991fe"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0d412c2cff36b5b7301ffe459e1250b2491991fe", @"/Areas/Admin/Views/Account/AccessDenied.cshtml")]
    ...
    public class Areas_Admin_Views_Account_AccessDenied : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "D:\code\Lessons\Ogani project from Mac\OganiMvcProject\Ogani\Ogani.WebUI\Areas\Admin\Views\Account\AccessDenied.cshtml"
...
#nullable disable
      ...
      */
        ...
        .ghost {
            ...
            .ghost:before {
                ...
                visibility: hidden;
                opacity: 0;
                /* have each string of text introduced as the ghost returns from the right edge of the screen, and for the length of time it takes to cover the centr");
            WriteLiteral(@"al portion (a fourth, which becomes an eight as the animation length is half the total duration) */
    ...
    - showText, showNewText, showFinalText to show the different string");
            WriteLiteral("s (the implementation is quite quirky and primed for optimization)\r\n     */\r\n        ");
...
<svg style=""display: none"">
    <symbol id=""keyhole""
        ...
        <g transform=""translate(0 -270.542)"">
            ...
            <path d=""M10.516 283.271h5.427c1.164 0 1.768.861 2.102 1.802l3.59 10.125c.334.94-.937 1.802-2.102 1.802H6.926c-1.165 0-2.437-.861-2.103-1.802l3.59-10.125c.");
            WriteLiteral(@"334-.94.938-1.802 2.103-1.802z""
                  fill=""#f1eedb""
                  paint-order=""stroke fill markers"" />
            <circle r=""6.06""
                    cy=""279.141""
                    ...
                    fill=""#282b24""
                    paint-order=""stroke fill markers"" />
            <path d=""M11.502 283.76h3.455c.741 0 1.126.733 1.338 1.534l2.286 8.614c.213.8-.597 1.534-1.338 1.534H9.216c-.742 0-1.551-.733-1.339-1.534l2.286-8.614c.212-.8.597-1.534 1.339-1.534z""
                  fill=""#282b24""
                  paint-order=""stroke fill markers"" />
        </g>
    </symbol>
    ...
    <symbol id=""ghost""
            ...
            viewBox=""0 0 26.458333 26.458334"">
        <g transform=""translate(0 -270.542)"">
            <path d=""M4.63 279.293c0-4.833 3.85-8.751 8.6-8.751 4.748 0 8.598 3.918 8.598 8.75H13.23zM4.725 279.293h16.914c.052 0 .19.043.19.096l-.095 14.329c0 .026-.011.05-.028.068a.093.093 0 0 1-.067.028c-.881 0-1.235-1.68-2.114-1");
            WriteLiteral(@".616-.995.072-1.12 2.082-2.114 2.154-.88.064-1.233-1.615-2.115-1.615-.881 0-1.233 1.615-2.114 1.615-.881 0-1.233-1.615-2.114-1.615-.882 0-1.236 1.679-2.115 1.615-.994-.072-1.12-2.082-2.114-2.154-.88-.063-1.41 1.077-2.114 1.616-.021.016-.05-.01-.067-.028a.097.097 0 0 1-.028-.068v-14.33c0-.052.042-.095.095-.095z""
                  fill=""#f1eedb""
                  paint-order=""stroke fill markers"" />
...
<script>// target the elements in the DOM used in the project
    ...
    const timeoutID = setTimeout(() => {
        // after the specifie");
            WriteLiteral(@"d time, change the cursor as to seemingly grab the key
    ...
    // d");
            WriteLiteral(@"efine the function which updates the position of the absolute-positioned key according to the mouse coordinates (and the keys own dimensions)
